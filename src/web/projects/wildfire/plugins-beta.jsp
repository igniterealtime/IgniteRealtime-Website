...
%>
 ...
 <%
    String path = request.getRealPath("/projects/wildfire/plugins-beta");
...
%>
 ...
 <html>
 <head>
 <title>Wildfire Beta Plugins</title>
     ...
     <div id="ignite_body_leftcol">
         ...
         <div id="ignite_int_body">
             ...
             <div id="ignite_body_header">
                 <h2>Wildfire Beta Plugins</h2>
             </div>
             <!-- END body header -->


             <div class="ignite_int_body_padding">
                 <p>Plugins extend and enhance the functionality of Wildfire. Below is a list of the
                 <b>beta</b> plugins available for <a href="index.jsp">Wildfire</a>. To install plugins,
                 copy the .jar file into the <tt>plugins</tt> directory of your Wildfire installation.</p>

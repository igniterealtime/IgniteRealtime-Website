	...
	<div id="ignite_body">
		...
		<div id="ignite_body_leftcol">
			...
			%>
				...
				<p>To submit a plugin please send an email to Matt Tucker (matt at jivesoftware dot com) or send him a <a href="http://www.igniterealtime.org/forum/pmpost!default.jspa?to=matt">private message</a> in the forums.</p>

        ...
        <div id="ignite_body_leftcol">
            ...
            <div id="ignite_int_body">
                ...
                <div class="ignite_int_body_padding">
                    ...
                    <a href="http://download.igniterealtime.org/openfire/docs/latest/README.html">Readme &amp; License</a></li>
                    <li><img src="../../images/icon_txt.gif" width="16" height="16" alt="txt" border="0" />
                    <a href="http://download.igniterealtime.org/openfire/docs/latest/changelog.html">Changelog</a>
                    <br>
                    <br></li>
                    <li><a href="http://download.igniterealtime.org/openfire/docs/latest/documentation/install-guide.html">Installation Guide</a> - How to install Openfire.</li>
                    <li><a href="http://download.igniterealtime.org/openfire/docs/latest/documentation/upgrade-guide.html">Upgrade Guide</a> - Instructions for upgrading an existing Openfire installation.</li>
                    <li><a href="http://download.igniterealtime.org/openfire/docs/latest/documentation/database.html">Database Installation Guide</a> -  How to setup your database for use with Openfire.</li>
                    <li><a href="http://download.igniterealtime.org/openfire/docs/latest/documentation/ssl-guide.html">SSL Guide</a> - A guide to setting up Openfire's SSL secure socket support.</li>
                    <li><a href="http://download.igniterealtime.org/openfire/docs/latest/documentation/ldap-guide.html">LDAP Guide</a> - A guide to setting up Openfire to work with LDAP user stores.</li>
                    <li><a href="http://download.igniterealtime.org/openfire/docs/latest/documentation/db-integration-guide.html">Custom Database Integration Guide</a> - A guide to integrating Openfire authentication, user, and group data with a custom database.</li>

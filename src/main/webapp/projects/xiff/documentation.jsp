    ...
    <main id="ignite_body_leftcol">
        <article id="ignite_int_body">
            ...
            <header id="ignite_body_header">
                <h2>XIFF API Documentation</h2>
            </header>

            <div class="ignite_int_body_padding">
                <p>
                    The current XIFF API documentation can be found below. All documentation is also distributed in each release.
                </p>
                ...
                <ul>
                    <li>
                        ...
                        <a href="https://download.igniterealtime.org/xiff/docs/latest/README.html">Readme</a>
                    </li>
                    <li>
                        <img src="../../images/icon_txt.gif" width="16" height="16" alt="txt" />
                        <a href="https://download.igniterealtime.org/xiff/docs/latest/changelog.html">Changelog</a>
                    </li>
                </ul>
            </div>
